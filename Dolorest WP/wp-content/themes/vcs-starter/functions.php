...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_deregister_script('jquery');
				...
				wp_register_script('jquery', ASSETS_URL . '/assets/js/jquery-1.12.4.min.js', false, '1.12.4', true);

				wp_register_script('isotope', ASSETS_URL . '/assets/js/isotope.pkgd.js', array('jquery'), 'Isotope PACKAGED v3.0.6', true);

				wp_register_script('masonry', ASSETS_URL . '/assets/js/masonry-horizontal.js', array('jquery','isotope'), 'Isotope v2.0.1', true);

        		wp_register_script('js_main', ASSETS_URL . '/assets/js/custom.js', array('jquery','isotope', 'masonry'), '1.0', true);
